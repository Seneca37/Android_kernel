...
then
	...
	echo "070INC_3UART"
	echo "102INC"
	echo "Example: ./mkconfig.sh 070INC"
	echo "In order to skip samkoonhmi.h md5sum check, use like:"
	echo "         ./mkconfig.sh 070INC AKHMI"
	echo "Others Type, use like:"
	echo "         ./mkconfig.sh 070INC DBN"
...
echo "-----------------------------------------------------------------"
make ARCH=arm CROSS_COMPILE=arm-eabi- am335x_evm_android_defconfig menuconfig
if [ "$1" == "070INC" ]
then
